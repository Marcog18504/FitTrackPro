...
- `edit-modal.tsx` contiene la modale di inserimento e modifica;
- `detail-modal.tsx` contiene la modale di dettaglio.
...
- controllo di tutti i 36 campi `Field`, ciascuno con una tipologia di input esplicita;
